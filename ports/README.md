...
|---|---|---|
| Java | [`java/`](java/) | under way; one module, reaching the `hash` and `place` conformance levels, designed in [`../docs/design/40-java-binding.md`](../docs/design/40-java-binding.md) |
